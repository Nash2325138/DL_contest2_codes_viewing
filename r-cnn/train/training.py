    ...
    for e in range(epoch):
        ...
        while True:
            try:
                ...
                print('{} epoch with training loss {}'.format(e + 1, np.mean(losses)))
                break
        ...
        while True:
            try:
                ...
                print('{} epoch with validation loss {}\n'.format(e + 1, np.mean(losses_v)))
                break
        if (e + 1) % 2 == 0:
            model.save_model(sess, step, './myrcnncheck-{}'.format(e + 1))
